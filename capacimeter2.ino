// high-dynamic capacimeter (found on the web)

// just plug the capacitor to measure between A2 (=+) and A0 (=GND)
...
/* CALIBRATED 2014-06-07 USING 10 uF REFERENCE CAPACITOR */
